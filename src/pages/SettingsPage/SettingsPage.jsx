    ...
    <ContainerContent>
      <DivWrapper>
        <Form onSubmit={(e) => e.preventDefault()}>
          ...
          />
          <Line />
          <PromptText>Change your first name...</PromptText>
          <Input
          ...
          />
          <Line />
          <PromptText>Change your last name...</PromptText>
          <Input
            placeholder="Age"
            type="text"
            value={age}
          ...
          />
          <Line />
          <PromptText>Change your last age...</PromptText>
          <Input
          ...
          />
          <Line />
          <PromptText>Change your last occupation...</PromptText>
          <Input
          ...
          />
          <Line />
          <PromptText>Change your last location...</PromptText>
